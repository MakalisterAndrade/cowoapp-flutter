...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      // Use GetMaterialApp em vez de MaterialApp para usar o GetX
      title: 'CoWoApp',
      ...
      getPages: [
        ...
        GetPage(
            name: '/cadastro_sala',
            page: () => CadastroSalaScreen()), // Tela de cadastro de salas
        GetPage(
            name: '/cadastro_cliente',
            page: () =>
                CadastroClienteScreen()), // Tela de cadastro de Clientes
        GetPage(
            name: '/reservar_sala',
            page: () => ReservaSalaScreen()), // Reserva de cadastro de salas

        GetPage(
            name: '/lista_salas_disponiveis',
            page: () =>
                ListagemSalasScreen()), // Tela de lista de salas disponíveis
        GetPage(
            name: '/historico_uso',
            page: () => HistoricoUsoScreen()), // Tela de histórico de uso
